...
public final class OperationContext {
    ...
    /**
     * Represents a global proxy to be used when making a request.
     */
    private static Proxy globlaProxy;
     ...
     * If the proxy is null, it returns OperationContext.getGlobalProxy()
     * 
     * @return A {@link java.net.Proxy} to use when making a request.
     */
    public Proxy getProxy() {
        return this.proxy != null ? this.proxy : OperationContext.getGlobalProxy();
    }
    ...
    public static void setGlobalProxy(Proxy proxy) {
    	OperationContext.globlaProxy = proxy;
    }
    ...
    public static Proxy getGlobalProxy() {
    	return OperationContext.globlaProxy;
    }
}
